...
_RISK_EXTENSIONS: dict[str, dict] = {
    ...
    ".docm": {"category": "macro_document", "risk": 25, "description": "Macro-enabled Word document"},
    ".xlsm": {"category": "macro_document", "risk": 25, "description": "Macro-enabled Excel spreadsheet"},
    ".pptm": {"category": "macro_document", "risk": 25, "description": "Macro-enabled PowerPoint presentation"},
    ".dotm": {"category": "macro_document", "risk": 25, "description": "Macro-enabled Word template"},
    ".xlam": {"category": "macro_document", "risk": 25, "description": "Macro-enabled Excel add-in"},
    # Executable files
    ".exe":  {"category": "executable", "risk": 30, "description": "Windows executable"},
    ".scr":  {"category": "executable", "risk": 30, "description": "Windows screensaver (executable)"},
    ".bat":  {"category": "executable", "risk": 25, "description": "Windows batch script"},
    ".cmd":  {"category": "executable", "risk": 25, "description": "Windows command script"},
    ".ps1":  {"category": "executable", "risk": 25, "description": "PowerShell script"},
    ".vbs":  {"category": "executable", "risk": 25, "description": "Visual Basic script"},
    ".vbe":  {"category": "executable", "risk": 25, "description": "Encoded Visual Basic script"},
    ".js":   {"category": "executable", "risk": 20, "description": "JavaScript file"},
    ".jse":  {"category": "executable", "risk": 20, "description": "Encoded JavaScript file"},
    ".wsf":  {"category": "executable", "risk": 25, "description": "Windows Script File"},
    ".msi":  {"category": "executable", "risk": 25, "description": "Windows installer package"},
    ".dll":  {"category": "executable", "risk": 30, "description": "Dynamic link library"},
    ".com":  {"category": "executable", "risk": 30, "description": "DOS/Windows executable"},
    ".pif":  {"category": "executable", "risk": 30, "description": "Program information file"},
    # Archive files
    ".zip":  {"category": "archive", "risk": 15, "description": "ZIP archive (may contain malware)"},
    ".rar":  {"category": "archive", "risk": 15, "description": "RAR archive (may contain malware)"},
    ".7z":   {"category": "archive", "risk": 15, "description": "7-Zip archive (may contain malware)"},
    ...
    # HTML attachments
    ".html": {"category": "html", "risk": 20, "description": "HTML file (possible credential harvesting)"},
    ".htm":  {"category": "html", "risk": 20, "description": "HTML file (possible credential harvesting)"},
    ".hta":  {"category": "html", "risk": 30, "description": "HTML Application (can execute code)"},
    ".svg":  {"category": "html", "risk": 10, "description": "SVG file (may contain embedded scripts)"},
    # Disk images
    ".iso":  {"category": "disk_image", "risk": 25, "description": "ISO disk image (bypasses MOTW)"},
    ".img":  {"category": "disk_image", "risk": 25, "description": "Disk image file"},
    ".vhd":  {"category": "disk_image", "risk": 25, "description": "Virtual hard disk"},
    ".vhdx": {"category": "disk_image", "risk": 25, "description": "Virtual hard disk (extended)"},
    # Shortcut files
    ".lnk":  {"category": "shortcut", "risk": 25, "description": "Windows shortcut (can run arbitrary commands)"},
    ".url":  {"category": "shortcut", "risk": 15, "description": "Internet shortcut file"},
    # Office with macros (legacy)
    ".doc":  {"category": "legacy_office", "risk": 10, "description": "Legacy Word document (may contain macros)"},
    ".xls":  {"category": "legacy_office", "risk": 10, "description": "Legacy Excel spreadsheet (may contain macros)"},
    ".ppt":  {"category": "legacy_office", "risk": 10, "description": "Legacy PowerPoint (may contain macros)"},
    ".rtf":  {"category": "legacy_office", "risk": 10, "description": "RTF document (may exploit vulnerabilities)"},
}
    ...
    for att in attachments:
        ...
        if ext in _RISK_EXTENSIONS:
            ...
            if ext_info["category"] == "macro_document":
                ...
                finding["warnings"].append("⚠️ HTML attachment (possible credential harvesting)")
            elif ext_info["category"] == "disk_image":
                finding["warnings"].append("⚠️ Disk image may bypass Mark-of-the-Web protection")
        ...
        if mime_risk > finding["risk_score"]:
            ...
            finding["warnings"].append(
                f"⚠️ Suspicious MIME type: {content_type}"
            )
        ...
        if finding["warnings"]:
            ...
            logger.warning(
                ...
                filename, finding["category"], finding["risk_score"],
            )
